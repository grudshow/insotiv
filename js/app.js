...
let sliderMini = new Swiper('.mini-slider__wrapper', {
	observer: true,
	observeParents: true,
	slidesPerView: 'auto',
	spaceBetween: 150,
...
let sliderProjects = new Swiper('.slider-projects__wrapper', {
	breakpoints: {
		601: {
			...
			speed: 800,
			navigation: {
				prevEl: '.slider-projects__arrow_prev',
				nextEl: '.slider-projects__arrow_next',
			},
			pagination: false,
		},
		310: {
...
let sliderPopup = new Swiper('.slider-popup__wrapper', {
	slidesPerView: 'auto',
	observer: true,
	observeParents: true,
	thumbs: {
		swiper: sliderProjects,
	},
	navigation: {
		prevEl: '.slider-popup__arrow_prev',
		nextEl: '.slider-popup__arrow_next',
	},
	breakpoints: {
		769: {
			allowTouchMove: false,
...
// let myFullPage = new fullpage('.page__wrapper', {
// 	autoScrolling: true,
...
// 		console.log("fullPage.js перекомпонован вручную");
// 	}
// });


// $(function () {
// 	$('.page__wrapper').fullpage({
// 		scrollBar: true,
// 		autoScrolling: true,
// 		scrollHorizontally: true,
// 	});
...
// myFullPage.slideSelector.forEach(item => {
// 	console.log(item)
// });
// console.log(myFullPage.slideSelector);
// function setScroollType() {
// 	if (wrapper.classList.contains('_free')) {
// 		wrapper.classList.remove('_free');
// 		// pageSlider.params.freeMode = false;
// 		// myFullPage.destroy();
// 		myFullPage.undestroy();
// 	}
...
var rellax = new Rellax('.parallax-drops', {
	speed: -2,
	// center: false,
	// wrapper: '.screen__content',
});
// let ticker = document.querySelector('.page__ticker');
// let text = ticker.innerHTML;
// setInterval(() => {
